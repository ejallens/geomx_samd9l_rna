---
title: "nanostring_geomx_proteogenomics_WTA_samd9l"
...
#loading the data
```{r}
datadir <- file.path("/Users/ericallenspach/r_projects/nanostring_rna_samd9l/20230331_Allenspach_AllSeq_samd9l")
```

```{r}
# automatically list files in each directory for use
DCCFiles <- dir(here("20230331_Allenspach_AllSeq_samd9l/","dccs"), pattern = ".dcc$",
                full.names = TRUE, recursive = TRUE)
PKCFiles <- dir(here("20230331_Allenspach_AllSeq_samd9l/","pkcs"), pattern = ".pkc$",
                                full.names = TRUE, recursive = TRUE)
SampleAnnotationFile <- dir(here("20230331_Allenspach_AllSeq_samd9l/", "annotation"), pattern = ".xlsx$", full.names = TRUE, recursive = TRUE)
```
